...
import static us.donut.skuniversal.plotsquared.PlotSquaredHook.plotAPI;
...
public class ExprPlotIDsOfPlayer extends SimpleExpression<String> {
    ...
    protected String[] get(Event e) {
        ...
        return plotAPI.getPlayerPlots(PlotPlayer.from(player.getSingle(e))).stream().map(plot -> plot.getId().toString()).toArray(String[]::new);
    }
