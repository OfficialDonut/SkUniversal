...
public class ExprPlayerPrefix extends SimpleExpression<String> {
    ...
    public String toString(@Nullable Event e, boolean arg1) {
        return "luckperms prefix of player";
    }
    ...
    protected String[] get(Event e) {
        if (player.getSingle(e) != null) {
            return new String[]{LuckPerms.getApi().getUser(player.getSingle(e).getUniqueId()).getCachedData().getMetaData(LuckPerms.getApi().getContextsForPlayer(player.getSingle(e))).getPrefix()};
        } else {
