...
public class EffAddSuffix extends Effect {
    ...
    public String toString(@Nullable Event e, boolean paramBoolean) {
        return "add suffix with priority to player";
    }
        ...
        if (prefix.getSingle(e) != null) {
            if (priority.getSingle(e) != null) {
                if (player != null) {
                    ...
                    user.setPermission(LuckPerms.getApi().getNodeFactory().makeSuffixNode(priority.getSingle(e).intValue(), prefix.getSingle(e)).build());
