...
public class ExprCannonDesign extends SimpleExpression<String> {
    ...
    static {
        Skript.registerExpression(ExprCannonDesign.class, String.class, ExpressionType.COMBINED, "[the] design [type] [name] of [the] cannon [with ID] %string%");
    }
    ...
    protected String[] get(Event e) {
        ...
        return new String[]{cannon.getCannonDesign().getDesignName()};
    }
