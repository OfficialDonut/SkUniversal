...
public class ExprCannonPitch extends SimpleExpression<Number> {

    static {
        Skript.registerExpression(ExprCannonPitch.class, Number.class, ExpressionType.COMBINED, "[the] [aiming] pitch of [the] cannon [with ID] %string%");
    }
    ...
    public String toString(@Nullable Event e, boolean b) {
        return "the pitch of the cannon with ID " + id.toString(e, b);
    }
    ...
    protected Number[] get(Event e) {
        ...
        return new Number[]{cannon.getAimingPitch()};
    }

    @Override
    public void change(Event e, Object[] delta, Changer.ChangeMode mode){
        double newPitch = ((Number) delta[0]).doubleValue();
        Cannon cannon;
        ...
        if (mode == Changer.ChangeMode.SET) {
            ...
            cannon.setAimingPitch(cannon.getTemperature() + newPitch);
