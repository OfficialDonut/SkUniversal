...
public class PvPLevelsRegister {
    ...
    public PvPLevelsRegister() {
        ...
        Skript.registerExpression(ExprPvPKills.class, Number.class, ExpressionType.COMBINED, "[the] [(number|amount) of] pvp kills of %offlineplayer%", "%offlineplayer%'s [(number|amount) of] pvp kills");
