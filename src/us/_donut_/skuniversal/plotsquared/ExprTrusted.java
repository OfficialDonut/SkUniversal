...
public class ExprTrusted extends SimpleExpression<OfflinePlayer>{
    ...
    public String toString(@Nullable Event e, boolean arg1) {
        return "trusted players of plot at loc " + loc.getSingle(e);
    }
    ...
    protected OfflinePlayer[] get(Event e) {
        if (loc.getSingle(e) != null) {
            ...
            for (UUID p : plot.getPlot(loc.getSingle(e)).getTrusted()) {
    ...
    public void change(Event e, Object[] delta, Changer.ChangeMode mode){
        ...
        if (mode == Changer.ChangeMode.ADD) {
            plot.getPlot(loc.getSingle(e)).addTrusted(player.getUniqueId());
        } else if (mode == Changer.ChangeMode.REMOVE) {
            plot.getPlot(loc.getSingle(e)).removeTrusted(player.getUniqueId());
        }
    }
    @Override
