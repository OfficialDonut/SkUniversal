...
public class AdvancedSurvivalGamesRegister {
    ...
    public AdvancedSurvivalGamesRegister() {
        ...
        Skript.registerExpression(ExprCurrentWorld.class, World.class, ExpressionType.SIMPLE, "[the] [advanced] (survival games|sg) current world");
        ...
        Skript.registerExpression(ExprTopPlayers.class, OfflinePlayer.class, ExpressionType.SIMPLE, "[the] [advanced] (survival games|sg) top players");
