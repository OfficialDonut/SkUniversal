...
public class PrisonMinesRegister {
    ...
    public static void registerPrisonMines() {
        if (Bukkit.getServer().getPluginManager().getPlugin("PrisonMines") != null) {
            ...
            //Events
            Skript.registerEvent("Mine Reset Start", EvtMineResetBegin.class, MinePreResetEvent.class, "[PrisonMines] mine reset (begin|start)");
            ...
            Skript.registerEvent("Mine Reset Finish", EvtMineResetEnd.class, MinePostResetEvent.class, "[PrisonMines] mine reset (finish|end|complete)");
