...
public class GriefPreventionRegister {
    ...
    public static void registerGriefPrevention() {
        if (Bukkit.getServer().getPluginManager().getPlugin("GriefPrevention") != null) {
            SkUniversal.hookedPlugins.add("GriefPrevention");
            ...
            //Events
            Skript.registerEvent("GriefPrevention Claim Deletion", EvtClaimDelete.class, ClaimDeletedEvent.class, "[GriefPrevention] claim delet(e|ion)");
            ...
            Skript.registerEvent("GriefPrevention Claim Expiration", EvtClaimExpire.class, ClaimExpirationEvent.class, "[GriefPrevention] claim expir(e|ation)");
            ...
            Skript.registerEvent("GriefPrevention Prevent Block Break", EvtPreventBreak.class, PreventBlockBreakEvent.class, "[GriefPrevention] prevent block [from] break[ing]");
            ...
            Skript.registerEvent("GriefPrevention Prevent PvP", EvtPreventPvP.class, PreventPvPEvent.class, "[GriefPrevention] prevent pvp");
            Skript.registerEvent("GriefPrevention Protect Drops", EvtProtectDrops.class, PreventPvPEvent.class, "[GriefPrevention] protect [death] drops");
            Skript.registerEvent("GriefPrevention Save Trapped Player", EvtSaveTrapped.class, SaveTrappedPlayerEvent.class, "[GriefPrevention] save trapped player");
