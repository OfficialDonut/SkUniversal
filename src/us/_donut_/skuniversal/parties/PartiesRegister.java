...
public class PartiesRegister {
    ...
    public PartiesRegister() {
        ...
        Skript.registerExpression(ExprPartyKills.class, Number.class, ExpressionType.COMBINED, "[the] [(number|amount of)] kills of [the] party [(named|with name)] %string%", "[the] party [(named|with name)] %string%'s [(number|amount of)] kills");
